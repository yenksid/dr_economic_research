...
Esta página publica una bibliografía **verificada y navegable** para auditar la investigación.

## Decisión editorial

La bibliografía pública separa tres cosas:

1. **Fuentes verificadas y navegables:** enlaces que respondieron correctamente al momento de la prueba.
2. **APIs o endpoints dinámicos:** fuentes de máquina que no deben presentarse como páginas normales para lectura humana.
3. **Enlaces problemáticos:** enlaces que devolvieron 404, error de servidor, bloqueo o fallo de conexión al momento de la prueba.

## Archivos públicos

- Bibliografía verificada: [`data/verified_public_bibliography_v1.csv`](../data/verified_public_bibliography_v1.csv)
- Registro de APIs/endpoints dinámicos: [`data/api_machine_endpoint_registry_v1.csv`](../data/api_machine_endpoint_registry_v1.csv)
- Reporte completo de salud de enlaces: [`data/source_link_health_report_v1.csv`](../data/source_link_health_report_v1.csv)
- Enlaces problemáticos separados: [`data/problem_source_links_v1.csv`](../data/problem_source_links_v1.csv)
- Bibliografía clave original: [`data/key_public_bibliography_v1.csv`](../data/key_public_bibliography_v1.csv)

## Conteo de auditoría

- Fuentes verificadas y navegables: **166**
- APIs/endpoints dinámicos separados: **28**
- Enlaces problemáticos separados: **29**

## Fuentes verificadas y navegables
...
Estos elementos pueden ser útiles para descarga, consulta automática o reconstrucción técnica, pero no se presentan como páginas normales de lectura.
...
Los enlaces que devolvieron 404, errores de servidor, bloqueo o fallos de conexión fueron separados del listado navegable. No deben usarse como citas públicas sin verificación manual o reemplazo.

## Línea de cautela

La bibliografía mejora la auditabilidad, pero no cambia la tesis:
